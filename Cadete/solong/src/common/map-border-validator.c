...
/*   Updated: 2023/07/20 09:22:57 by mister-code      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <map_of.h>

static t_map_error	top_bottom_validation(t_map *map, int x, int y)
{
	while (++y < 2)
	{
		x = -1;
...
static t_map_error	between_validation(t_map *map, int x, int y)
{
	while (++x < 2)
	{
		y = 0;
