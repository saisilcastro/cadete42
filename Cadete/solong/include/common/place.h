...
/*   Updated: 2023/07/20 18:39:38 by mister-code      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct s_place
{
	...
	t_status	(*image_load_first)(t_place * set, char *path, int id);
	t_status	(*image_load_last)(t_place * set, char *path, int id);
...
extern t_status	place_image_load_first(t_place *set, char *path, int id);
extern t_status	place_image_load_last(t_place *set, char *path, int id);
