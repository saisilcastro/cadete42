...
/*   Updated: 2023/05/22 14:32:53 by lde-cast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern void     image_of_start(t_image *set, t_vi2d size, t_pixel color);
extern t_image  *image_of_set(void *plugin, t_vi2d size);
extern t_image	*image_of_buffer(void *buffer, t_vi2d size);
