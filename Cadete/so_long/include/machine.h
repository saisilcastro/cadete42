...
/*   Updated: 2023/05/22 17:25:04 by lde-cast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct s_machine{
	...
	void		(*image_load)(t_machine *set, char *path, B32 id, t_vi2d pos);
	void		(*object_create)(t_machine *set, B32 id, t_vi2d size, t_vi2d pos);
	...
	void		(*print)(t_machine *set, B32 x, B32 y, t_pixel color, char *str);
};
