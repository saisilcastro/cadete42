...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/14 21:41:50 by elraira-          #+#    #+#             */
/*   Updated: 2023/06/14 23:03:59 by elraira-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Brain::Brain(Brain const& src) {
    *this = src;
    std::cout << WHITE << "Copy Brain created!" << RESET << std::endl;
}

Brain::~Brain(void) {
    std::cout << WHITE << "Brain destroyed!" << RESET << std::endl;
}
